...
export const FORM_CONFIGS: Record<FormContext, FormConfig> = {
  inquiry: {
    ...
    fields: [
      ...
      { token: 'branche', group: 'optional' },
      { token: 'wieGefunden', group: 'optional' },
      { token: 'dsgvo', required: true, group: 'consent' },
      { token: 'newsletter', group: 'consent' },
    ],
