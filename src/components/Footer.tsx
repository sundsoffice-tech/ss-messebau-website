...
export const Footer = memo(function Footer() {
  ...
  return (
    <footer className="bg-surface-deep text-on-deep-muted mobile-safe-bottom">
      <div className="border-b border-white/10">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-center sm:text-left">
              <p className="font-bold text-white text-base sm:text-lg">{t('guarantee.title')}</p>
              <p className="text-sm text-on-deep-muted">{t('guarantee.subtitle')}</p>
            </div>
            <button
              onClick={(e) => handleNavigation('/kontakt', e)}
              className="inline-flex items-center gap-2 rounded-md bg-accent px-5 py-2.5 text-sm font-medium text-accent-foreground shadow-sm transition-all hover:bg-accent/90 hover:shadow-md active:scale-[0.98] whitespace-nowrap"
            >
              {t('guarantee.cta')}
            </button>
          </div>
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-white/90 rounded-xl flex-shrink-0">
                <img 
                  src={logo} 
                  alt=""
                  width="48"
              ...
              <div>
                ...
                <div className="text-xs text-on-deep-muted uppercase tracking-widest">
                  GbR · Full-Service Messebau
                </div>
              </div>
            </div>
            <div className="w-12 h-0.5 bg-accent/60 rounded-full mb-4" />
            <p className="text-sm text-on-deep-muted leading-relaxed">
              {t('footer.company.desc')}
            </p>
          </div>

          <div>
            <h3 className="font-semibold mb-3 sm:mb-4 text-base text-white">{t('footer.services')}</h3>
            <nav aria-label={t('footer.servicesNav')}>
              <ul className="space-y-2 text-sm text-on-deep-muted">
                <li>
                  <button 
          ...
          <div>
            <h3 className="font-semibold mb-3 sm:mb-4 text-base text-white">{t('footer.company')}</h3>
          ...
          <div>
            <h3 className="font-semibold mb-3 sm:mb-4 text-base text-white">{t('footer.contact')}</h3>
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-on-deep-muted">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-on-deep-muted">
          <div className="text-center sm:text-left">
          ...
          <div className="flex items-center gap-3" role="group" aria-label={t('share.ariaLabel')}>
            <span className="text-xs text-on-deep-muted">{t('share.label')}</span>
            <div className="flex items-center gap-1">
              {FOOTER_SHARE_PLATFORMS.map((platform) => (
                <ShareButton
                  ...
                  size="sm"
                  source="footer"
                  className="text-on-deep-muted hover:text-white focus-visible:text-white"
                />
              ))}
            </div>
          </div>
          ...
          <nav aria-label={t('footer.legal.nav')}>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
              <button
                ...
                className="hover:text-white focus-visible:text-white transition-colors min-h-[44px] py-2 focus-visible:outline-none focus-visible:underline"
              >
