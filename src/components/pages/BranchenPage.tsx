...
export function BranchenPage() {
  ...
  return (
    <div>
      <section id="branchen-hero" className="relative overflow-hidden hero-gradient text-white py-12 sm:py-16">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="heading-display font-bold mb-4 sm:mb-6 leading-tight">{t('branchen.hero.title')}</h1>
