      ...
      <section id="branchen-content" className="py-12 sm:py-16">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 mb-8 sm:mb-12 h-auto">
            ...
            <TabsContent value="messebau" className="space-y-6 sm:space-y-8" id="messebau">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                <div>
                  ...
                  <div className="space-y-2 sm:space-y-2.5 lg:space-y-3 mb-6">
                    {[
                ...
                <div className="group aspect-square rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 border-2 hover:border-primary mt-4 sm:mt-5 lg:mt-0">
                  <img 
            ...
            <TabsContent value="eventbau" className="space-y-6 sm:space-y-8" id="eventbau">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                ...
                <div className="group aspect-square rounded-lg overflow-hidden lg:order-1 shadow-xl hover:shadow-2xl transition-shadow duration-300 border-2 hover:border-primary mt-4 sm:mt-5 lg:mt-0">
                  <img 
